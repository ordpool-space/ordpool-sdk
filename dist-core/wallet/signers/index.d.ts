 ...
 */
export declare const walletSigners: readonly WalletSigner[];
/**
 ...
 */
export declare function findSigner(type: KnownOrdinalWalletType): WalletSigner | undefined;
export declare function findSignerOrThrow(type: KnownOrdinalWalletType): WalletSigner;
