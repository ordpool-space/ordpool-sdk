...
export interface WalletSigner {
    readonly providerId: KnownOrdinalWalletType;
    signSingleFundingInput(input: SignSingleFundingInputArgs): Observable<{
        txId: string;
    }>;
    signTransfer(input: SignTransferArgs): Observable<{
        txId: string;
    }>;
    signOfferAccept(input: SignOfferAcceptArgs): Observable<{
        txId: string;
    }>;
...
export interface WalletSignerInternalImpls {
    signAndBroadcast(input: SignAndBroadcastInput): Observable<{
        txId: string;
    }>;
    signMultiInputAndBroadcast(input: SignMultiInputAndBroadcastInput): Observable<{
        txId: string;
    }>;
    signPsbtOnly(input: SignPsbtOnlyInput): Observable<Uint8Array>;
}
export declare enum KnownOrdinalWalletType {
    xverse = "xverse",
    leather = "leather",
    unisat = "unisat",
    wizz = "wizz",
...
export declare const KnownOrdinalWallets: {
...
//# sourceMappingURL=wallet.service.types.d.ts.map