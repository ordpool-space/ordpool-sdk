 ...
 */
export type AgentActionKind = 'cat21_mint' | 'cat21_transfer' | 'cat21_create_offer' | 'cat21_accept_offer';
...
export type AgentPolicyDenyReason = 'agent-disabled' | 'spend-above-action-cap' | 'spend-above-daily-cap' | 'fee-rate-above-ceiling' | 'price-below-floor' | 'counterparty-not-allowed';
//# sourceMappingURL=agent-policy.types.d.ts.map