 ...
 */
export declare const STANDARD_TX_WEIGHT_LIMIT = 400000;
/**
 ...
 * no side effects.
 */
export declare function decideBroadcastChannel(input: Cat21BroadcastInput, options?: Cat21BroadcastOptions): Cat21BroadcastDecision;
/**
 * # DORMANT — currently unused by any SDK consumer.
 *
 ...
 */
export declare function broadcastCat21(input: Cat21BroadcastInput, broadcastViaMempool: (hex: string) => Promise<string>, options?: Cat21BroadcastOptions): Promise<Cat21BroadcastResult>;
//# sourceMappingURL=broadcast.helper.d.ts.map