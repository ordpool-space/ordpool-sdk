 ...
 * v2 rebuild.
 */
declare const CAT21_LISTING_MESSAGE_VERSION = "v2";
/**
 ...
 */
type ListingMessageFields = Pick<Cat21Listing, 'catNumber' | 'network' | 'askSats' | 'payTo' | 'catTxid' | 'catVout' | 'ordinalsAddress' | 'signedAt'>;
/**
