...
export declare function describeWalletRejection(outcome: WalletProbeOutcome): WalletRejectionShape;
/** The shape a genuine refusal has, whatever the wallet called it. */
export declare const REFUSED_WITH_DETAIL: WalletRejectionShape;
//# sourceMappingURL=wallet-rejection.d.ts.map