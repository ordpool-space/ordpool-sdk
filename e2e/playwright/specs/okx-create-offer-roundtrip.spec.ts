...
test.fixme('build + sign a CAT-21 buy-offer on regtest via OKX (buyer): seller raw-key mints, OKX signs input 1, seller signs input 0, assert via electrs', async () => {
