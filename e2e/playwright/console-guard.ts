 ...
 *   - jsdom-style warnings from the harness bundle in headless runs
 ...
 *
 * Twin file lives at ~/Work/ordpool/cat21-indexer/frontend/e2e/regtest/console-guard.ts;
 * keep them in step (they diverge only on filter patterns per stack).
 */
