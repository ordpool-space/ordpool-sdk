 ...
 */
export function fundWithFreshCoinbase(address: string): number {
  rpc(RPC_WALLET_ARG, 'generatetoaddress', '1', address);
  // Coinbase outputs are unspendable until 100 further blocks confirm them.
  mineBlocks(100);
  return Number(rpc('getblockcount'));
}
 ...
 */
let seedWalletSeq = 0;
function uniqueSeedWalletName(base: string): string {
  seedWalletSeq += 1;
