 ...
 * alternative.
 */
export function compressBrotli(body: Uint8Array): Uint8Array {
  ...
  try {
    ...
    zlib = require('node:zlib') as typeof import('node:zlib');
  } catch {
    throw new Error(
      'compressBrotli: node:zlib is not available in this runtime. ' +
